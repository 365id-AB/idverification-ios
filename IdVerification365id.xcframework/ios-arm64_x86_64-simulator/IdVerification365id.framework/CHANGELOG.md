...
- Updated the existing gRPC communicator to improve communication with the 365id backend.
- Improved nil value checks.
...
- Updated iProov and micro blink checksum in Package.swift.
...
- Shows the animation's based on the identified document type.

## [2.5.4] - 2024-06-14

### Updated

- Replaced the Production host name.
...
- Improved the error handling for NFC reading.
